              ...
              {isEvenIndex(index) && (
                <div className="w-[100%] md:w-[50%]">
                 <li
                    key={feature.id}
                    id={feature.id}
                    className={`feature flex flex-col w-[100%] items-center pr-4 pt-4 ${animatedFeatures.includes(feature.id) ? 'animate-slide-in-left' : ''} ${feature.id === excludedFeatureId ? 'md:mb-[30rem]' : 'md:mt-[30rem]'}`}
