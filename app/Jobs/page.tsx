 ...
 return (
    <>
      ...
      <section className="max-container padding-container flex flex-col gap-10 py-16 pb-80 md:gap-10 lg:py-20 relative">
        ...
        <h2 className="text-center text-3xl mt-6 text-red-600 border-b-4 ">At the moment, Foxy Voxel is not looking to expand the team, nor is offering an internship.<br/>Check back soon and keep an eye on our social media pages for when we open new positions.</h2>
